...
{
    public class PlotBuilder : IPlotBuilder, IPlotTimeBuilder
    {
        ...
        public PlotBuilder(IAmazonCloudWatch cloudWatch, ISeriesBuilder seriesBuilder)
        {
            this.cloudWatch = cloudWatch;
            this.seriesBuilder = seriesBuilder;
        }

        IPlotMetricBuilder IPlotTimeBuilder.AddMetric(string metricNamespace, string metricName)
        {
        ...
        async Task<PlotModel> IPlotTimeBuilder.Generate()
        {
        ...
        {
            metricStartTime = metricsStartTime;
            metricEndTime = metricsEndTime;
            return this;
        }
    }
}
